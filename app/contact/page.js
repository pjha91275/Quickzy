          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl flex-1">
              ...
              <div className="space-y-6">
                {[
                   { icon: <FiPhone />, label: "Emergency Helpline", val: <a href="tel:+911800419123" onClick={(e) => { e.preventDefault(); window.location.href = "tel:+911800419123"; }} className="hover:text-[#3BB77E] transition-colors relative z-10 font-black text-[#253D4E] cursor-pointer">+91 1800-419-123</a> },
                   { icon: <FiMail />, label: "Support Email", val: <a href="mailto:shopquickzy@gmail.com?subject=Quickzy Support Inquiry" onClick={(e) => { e.preventDefault(); window.location.href = "mailto:shopquickzy@gmail.com?subject=Quickzy Support Inquiry"; }} className="hover:text-[#3BB77E] transition-colors relative z-10 font-black text-[#253D4E] cursor-pointer">shopquickzy@gmail.com</a> },
                   { icon: <FiClock />, label: "Hours of Service", val: <span className="font-black text-[#253D4E]">24/7 Premium Support</span> },
                   { icon: <FiMapPin />, label: "Head Office", val: <span className="font-black text-[#253D4E]">Worli, Mumbai</span> }
                ].map((item, i) => (
