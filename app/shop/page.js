...
export const allProducts = [
  ...
  },
  {
    ...
    oldPrice: 95,
    unit: "200 GM",
    description: "Amul Fresh Paneer is synonymous with purity and softness, making it a favorite for Indian curries and snacks. It is made from fresh milk and is packed using advanced technology to retain its texture and flavor for longer periods. Whether you are making Paneer Tikka, Palak Paneer, or a simple stir-fry, it absorbs flavors beautifully while remaining tender. It is a rich source of protein and calcium, making it an excellent addition to a balanced vegetarian diet.",
    vendor: "Amul",
    category: "Dairy",
    discount: "11%",
    rating: 4.5,
  ...
  },
  {
    ...
    oldPrice: 60,
    unit: "1 PCS",
    description: "Our Cauliflower is known for its compact, snowy white curds and fresh, crunchy texture that stands up well to various cooking methods. It is a low-calorie alternative to grains and is incredibly rich in fiber and various essential vitamins. Whether you are roasting it with spices, making Gobi Manchurian, or using it in a traditional curry, it adds a delightful texture and mild flavor. We select heads that are heavy and free from spots, guaranteeing freshness and a long usage window.",
    vendor: "Quickzy Fresh",
    category: "Vegetables",
    discount: "33%",
    rating: 4.1,
  ...
  },
  {
    ...
    oldPrice: 125,
    unit: "1 LTR",
    description: "Real Fruit Power Mixed Fruit is a delicious blend of nine exotic fruits, providing a rich source of vitamins and natural energy. It is made from high-quality fruit pulps without any added preservatives, ensuring you get the wholesome goodness of nature in every glass. Perfectly refreshing at any time of day, it is a great alternative to carbonated drinks for both kids and adults. Enjoy the balanced sweetness and the medley of fruit flavors that make this a favorite for healthy family breakfasts.",
    vendor: "Real",
    category: "Beverages",
    discount: "12%",
    rating: 4.1,
  ...
  },
  {
    ...
    oldPrice: 350,
    unit: "200 GM",
    description: "Happilo Roasted and Salted Almonds are a healthy and delicious snack choice for health-conscious individuals seeking a boost of energy. These premium almonds are expertly roasted to enhance their natural nuttiness and lightly seasoned for a perfect savory finish. They are a rich source of Vitamin E, magnesium, and healthy fats, promoting heart health and improved cognitive function. Perfect for carrying in your gym bag, office drawer, or keeping at home for a quick, nutrient-dense snacking option.",
    vendor: "Happilo",
    category: "Snacks",
    discount: "30%",
    rating: 4.7,
  ...
  },
  {
    ...
    oldPrice: 110,
    unit: "400 GM",
    description: "Haldiram's Bhujia Sev is an iconic Indian snack made from spicy tepary bean and gram flour noodles, fried to a perfect crisp. Its unique blend of spices offers a savory and slightly tangy flavor profile that is addictive and satisfying at the same time. This bhujia is perfect as a standalone snack or can be used as a crunchy topping for chaats, salads, and traditional Indian meals. Made under stringent quality controls, it maintains its crunch and authentic taste for an extended period.",
    vendor: "Haldiram",
    category: "Snacks",
    discount: "14%",
    rating: 4.8,
  ...
  },
  {
    ...
    oldPrice: 599,
    unit: "1 PCS",
    description: "BoAt Bassheads 100 wired earphones feature a unique hawk-inspired design that is stylish and provides a comfortable in-ear fit for long hours. Equipped with 10mm dynamic drivers, they deliver clear sound with powerful, super extra bass that brings your music to life. The integrated microphone with a multi-function button allows for easy hands-free calling and music control on the go. Its durable, tangle-free cable ensures a hassle-free experience whether you are commuting, working, or exercising.",
    tag: "Sale",
    vendor: "BoAt",
    category: "Electronics",
    discount: "33%",
  ...
  },
  {
    ...
    oldPrice: 3999,
    unit: "1 PCS",
    description: "The boAt Watch Storm is the perfect companion for your fitness transformation, featuring a clear 1.3-inch curved display that is both elegant and durable. Its daily activity tracker and 9 different sports modes help you monitor your heart rate and oxygen levels with precision. With its 5ATM water resistance, you can wear it through sweat and splashes without any concern during your intense workouts. Long battery life ensures that you stay connected to your health goals for days on a single charge.",
    vendor: "BoAt",
    category: "Electronics",
    tag: "New",
    discount: "50%",
  ...
  },
  {
    ...
    oldPrice: 950,
    unit: "5 LTR",
    description: "Saffola Gold is a premium blended edible oil that contains the goodness of Rice Bran and Sunflower oil for a healthy heart journey. Equipped with Losorb technology, it ensures that your food absorbs significantly less oil, making your meals lighter and healthier for the whole family. It is rich in natural antioxidants and Oryzanol, which help in managing cholesterol levels effectively when part of a balanced diet. This 5-liter jar is a convenient and economical choice for households that prioritize both flavor and health.",
    vendor: "Marico",
    category: "Grocery",
    discount: "11%",
    rating: 4.5,
...
export default function Shop() {
  ...
  // Keep allProducts as local state derived from the exported array
          ...
          <div className="bg-white border rounded-2xl p-6 shadow-sm">
            ...
            <div className="space-y-6">
              {allProducts.slice(0, 3).map((item, idx) => (
                <Link key={idx} href={`/product/${item.id}`} className="flex gap-4 group cursor-pointer">
