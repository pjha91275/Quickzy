    ...
    <header className="w-full bg-white border-b relative font-sans">
      ...
      <div className="container mx-auto p-4 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div className="flex gap-6 items-center text-gray-500 text-sm">
          ...
          <Link href="/cart" className="flex items-center gap-1 cursor-pointer hover:-translate-y-1 transition-transform">
            <div className="relative">
              <FiShoppingCart className="text-2xl" />
              <span className="absolute -top-1 -right-1 bg-green-500 text-white rounded-full w-4 h-4 text-xs flex items-center justify-center">2</span>
            </div>
